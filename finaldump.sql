...
INSERT INTO `accounts` VALUES (11,9,80,'asdads','kamal','1',0),(21,2,30,'sectranpass',NULL,'1',0),(22,1,170,'asds','kamal2','1',0),(25,10,0,'tranPass103','user103','1',0);
...
CREATE TABLE `customers` (
  ...
  UNIQUE KEY `unq_contact` (`contact`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb3 COMMENT='contains user information and auth';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `customers` VALUES (1,'UnoCusto','PriPass',123451,'unocusto@mail.com',0,'2023-08-28 15:50:23',3),(2,'Harsh','SecPass',545,'deuusto@mail.com',1,NULL,0),(9,'kamal','kamal6',12345,'kamal@mail.com',1,'2023-08-29 09:38:40',0),(10,'user103','pass103',9968103,'user103@mail.com',1,'2023-08-28 17:11:02',0),(14,'askdhaiwd','qwerty',754,'dadwa@asdadawd',1,NULL,0),(15,'new123','new123',1234,'new123@mail.com',1,'2023-08-29 09:40:29',0);
...
-- Dump completed on 2023-08-30 10:57:20
